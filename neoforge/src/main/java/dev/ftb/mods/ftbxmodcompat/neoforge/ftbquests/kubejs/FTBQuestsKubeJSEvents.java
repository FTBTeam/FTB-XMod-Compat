...
public interface FTBQuestsKubeJSEvents {
	...
	TargetedEventHandler<String> CUSTOM_REWARD = EVENT_GROUP.server("customReward", () -> CustomRewardKubeEvent.class)
			.supportsTarget(EventTargetType.STRING).hasResult();
	TargetedEventHandler<String> OBJECT_COMPLETED = EVENT_GROUP.server("completed", () -> QuestObjectProgressKubeEvent.Completed.class)
			.supportsTarget(EventTargetType.STRING);
	TargetedEventHandler<String> OBJECT_STARTED = EVENT_GROUP.server("started", () -> QuestObjectProgressKubeEvent.Started.class)
			.supportsTarget(EventTargetType.STRING);
